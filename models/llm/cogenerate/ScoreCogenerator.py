...
Example Pitch{TopicCogenerator.append_short}Example Topic{ScoreJustificationCogenerator.dict_append_short[score_name]}Example {score_name} Justification{dict_append_short[score_name]}1""" + response_sep + """INPUT:
"""
